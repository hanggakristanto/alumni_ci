...
class Ak_model extends CI_Model
{
    ...
    {
        $query = $this->db->query('SELECT * FROM `akreditasi` WHERE MONTH(tanggal_posting) = MONTH(CURRENT_DATE()) AND YEAR(tanggal_posting) = YEAR(CURRENT_DATE()) ORDER by `id` DESC');
