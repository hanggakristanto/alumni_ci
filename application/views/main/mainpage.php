		...
		<br>
		<br>
			<span class="subtitle  white-text"><h1 data-aos="fade-down"> </h1></span><br>
			<?php echo anchor('#testimoni', 'testimoni', 'class="waves-effect waves-light btn-large blue accent-4" data-aos="fade-left"'); ?>
			<?php echo anchor('auth/login', 'Ruang Alumni', 'class="waves-effect waves-light btn-large teal accent-4" data-aos="fade-left"'); ?>
		</div>
		<div class="container">
			<div class="row">			
