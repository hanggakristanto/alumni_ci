<html>
	<head>
        ...
        <!-- Favicon-->
        <link rel="icon" href="<?php echo base_url('assets'); ?>/01.jpg" type="image/x-icon">
    ...
    <a href="#Main" class="logo" style="margin: 7px;">
                    <img height="50px" src="<?php echo base_url('assets'); ?>/logo.png">
                </a>
      ...
      <li><?php echo anchor('main', 'Home'); ?></li>
					        ...
					        <li><?php echo anchor('auth/login', 'Ruang Alumni'); ?></li>
      ...
      <li><?php echo anchor('main', 'Home'); ?></li>
			...
			<!-- <nav>
		    	<div class="nav-wrapper">
		    	<a href="#" class="brand-logo"><i class="material-icons"></i><img height="50px" src="https://antarbangsa.ac.id/wp-content/uploads/2020/04/logo-antarbangsa-200-400x138.png" ></a>	
                <div class="container">
